  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://chenglou.me/pretext/">
        <img src="gallery/official-demos.jpg" alt="Official Pretext Demos" width="100%">
    ...
    <td align="center" width="33%">
      <a href="https://pretext-breaker.netlify.app">
        <img src="gallery/pretext-breaker.jpg" alt="Pretext Breaker" width="100%">
    ...
    <td align="center" width="33%">
      <a href="https://shinichimochizuki.github.io/tetris-pretext/">
        <img src="gallery/tetris-pretext.jpg" alt="Tetris x Pretext" width="100%">
  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://illustrated-manuscript.vercel.app/">
        <img src="gallery/illustrated-manuscript.jpg" alt="Illustrated Manuscript" width="100%">
    ...
    <td align="center" width="33%">
      <a href="https://aiia.ro/pretext/">
        <img src="gallery/dragon-through-text.jpg" alt="Dragon Through Text" width="100%">
    ...
    <td align="center" width="33%">
      <a href="https://github.com/frmlinn/bad-apple-pretext">
        <img src="gallery/official-demos.jpg" alt="Bad Apple ASCII" width="100%">
...
|------|--------|-------------|------|
| **Bad Apple!! ASCII** | frmlinn | The legendary Bad Apple!! shadow art PV as real-time ASCII text animation | [![GitHub](https://img.shields.io/github/stars/frmlinn/bad-apple-pretext?style=flat-square)](https://github.com/frmlinn/bad-apple-pretext) |
| **Pretext Playground** | 0xNyk | Interactive ASCII dragon, physics-driven letters, fire breathing, 3D text tunnel | [![GitHub](https://img.shields.io/github/stars/0xNyk/pretext-playground?style=flat-square)](https://github.com/0xNyk/pretext-playground) |
| **Pretext Breaker** | rinesh | Breakout-style arcade game where bricks are made of text, with sound effects | [![GitHub](https://img.shields.io/github/stars/rinesh/pretext-breaker?style=flat-square)](https://github.com/rinesh/pretext-breaker) |
| **Tetris x Pretext** | shinichimochizuki | Classic Tetris reimagined with Pretext-powered text layout | [![GitHub](https://img.shields.io/github/stars/shinichimochizuki/tetris-pretext?style=flat-square)](https://github.com/shinichimochizuki/tetris-pretext) |
| **Somnai Pretext Demos** | somnai-dreams | Five polished demos: editorial engine, fluid smoke ASCII, justification comparison | [![GitHub](https://img.shields.io/github/stars/somnai-dreams/pretext-demos?style=flat-square)](https://github.com/somnai-dreams/pretext-demos) |
| **PreText Experiments** | qtakmalay | Eleven demos including Dragon animation, Anime Walk, Masonry layout | [![GitHub](https://img.shields.io/github/stars/qtakmalay/PreTextExperiments?style=flat-square)](https://github.com/qtakmalay/PreTextExperiments) |

### Visual & Interaction

| Demo | Author | Description | Repo |
|------|--------|-------------|------|
| **Pretext Explosive** | SamiKamal | Text that shatters — explosive particle effects powered by Pretext layout | [![GitHub](https://img.shields.io/github/stars/SamiKamal/pretext-explosive?style=flat-square)](https://github.com/SamiKamal/pretext-explosive) |
| **Star Wars Crawl** | berryboylb | The iconic opening crawl recreated with perspective text animation | [![GitHub](https://img.shields.io/github/stars/berryboylb/star-wars-pretext-demo?style=flat-square)](https://github.com/berryboylb/star-wars-pretext-demo) |
| **Singularity & Liquid Grid** | progrmoiz | Black-hole text singularity, liquid dashboard grid, and draw-to-fill text vessels | [![GitHub](https://img.shields.io/github/stars/progrmoiz/pretext-demos?style=flat-square)](https://github.com/progrmoiz/pretext-demos) |
...
| Demo | Author | Description | Repo |
|------|--------|-------------|------|
| **Illustrated Manuscript** | dengshu2 | Medieval illuminated manuscript with animated dragon and live text reflow | [![GitHub](https://img.shields.io/github/stars/dengshu2/illustrated-manuscript?style=flat-square)](https://github.com/dengshu2/illustrated-manuscript) |
| **Text Flow Demo** | MaiMcdull | News-style flowing text layout with a comparison shim for benchmarking | [![GitHub](https://img.shields.io/github/stars/MaiMcdull/pretext-text-flow-demo?style=flat-square)](https://github.com/MaiMcdull/pretext-text-flow-demo) |
| **Sea of Words** | Mukul-svg | Words flowing as ocean waves with wrap geometry in a canvas scene | [![GitHub](https://img.shields.io/github/stars/Mukul-svg/sea-of-words?style=flat-square)](https://github.com/Mukul-svg/sea-of-words) |
| **World Model Test** | CharlieGreenman | Minimal world-model interface powered by DOM-free text measurement | [![GitHub](https://img.shields.io/github/stars/CharlieGreenman/world-model-test?style=flat-square)](https://github.com/CharlieGreenman/world-model-test) |
...
|---------|-------|-------------|-------------|
| [pretext](https://github.com/chenglou/pretext) | ![Stars](https://img.shields.io/github/stars/chenglou/pretext?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/chenglou/pretext?style=flat-square) | The library itself — DOM-free text measurement and layout |
| [always-fit-resume](https://github.com/vladartym/always-fit-resume) | ![Stars](https://img.shields.io/github/stars/vladartym/always-fit-resume?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/vladartym/always-fit-resume?style=flat-square) | Resume builder that auto-scales to always fit one page |
| [textura](https://github.com/razroo/textura) | ![Stars](https://img.shields.io/github/stars/razroo/textura?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/razroo/textura?style=flat-square) | Pretext x Yoga — DOM-free layout engine for the web |
| [pinch-type](https://github.com/lucascrespo23/pinch-type) | ![Stars](https://img.shields.io/github/stars/lucascrespo23/pinch-type?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/lucascrespo23/pinch-type?style=flat-square) | Pinch to zoom text, not the page |
| [swift-pretextkit](https://github.com/tornikegomareli/swift-pretextkit) | ![Stars](https://img.shields.io/github/stars/tornikegomareli/swift-pretextkit?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/tornikegomareli/swift-pretextkit?style=flat-square) | Swift port of Pretext for Apple platforms |
| [layout-sans](https://github.com/BaselAshraf81/layout-sans) | ![Stars](https://img.shields.io/github/stars/BaselAshraf81/layout-sans?style=flat-square) | ![Last commit](https://img.shields.io/github/last-commit/BaselAshraf81/layout-sans?style=flat-square) | Pure TypeScript 2D layout engine — Flex, Grid, Magazine — zero DOM |
